    ...
    <div class="privacy-police">
        ...
        <div class="privacy-police__body">
            ...
            <div class="privacy-police__body-paragraph">
                <h6 class="privacy-police__body-title">1. Общие положения</h6>
                <p class="privacy-police__body-text">
                ...
                <p class="privacy-police__body-item">
                    <span>1.1.</span> Оператор ставит своей важнейшей целью и условием осуществления
                    своей деятельности соблюдение прав и свобод человека и гражданина при обработке
                ...
                <p class="privacy-police__body-item">
                    ...
                    <a href="#">https://thismywebsite.com</a>.
                </p>
            </div>
            <div class="privacy-police__body-paragraph">
                <h6 class="privacy-police__body-title">
                ...
                <p class="privacy-police__body-item">
                    <span>2.2.</span> Блокирование персональных данных — временное прекращение
                ...
                <p class="privacy-police__body-item">
                    ...
                    в сети интернет по сетевому адресу <a href="#">https://thismywebsite.com</a>.
                </p>

                <p class="privacy-police__body-item">
                    <span>2.4.</span> Информационная система персональных данных — совокупность
                    содержащихся в базах данных персональных данных и обеспечивающих их обработку
                    информационных технологий и технических средств.
                </p>

                <p class="privacy-police__body-item">
                    <span>2.5.</span> Обезличивание персональных данных — действия, в результате
                ...
                <p class="privacy-police__body-item">
                    <span>2.7.</span> Оператор — государственный орган, муниципальный орган,
                ...
                <p class="privacy-police__body-item">
                    <span>2.8.</span> Персональные данные — любая информация, относящаяся прямо или
        ...
        <BaseFooterSimple :showPrivacyPolice="false" class="privacy-police__footer" />
        <button class="privacy-police__btn-back" @click="$router.go(-1)">Вернуться</button>
    </div>
</template>
...
.privacy-police {
    ...
    &__title {
        @include font(500, 40px, 100%);
        letter-spacing: 1px;
        text-transform: uppercase;
    }
    &__body-title {
        @include font(500, 24px, inherit);
        margin-bottom: 20px !important;
    }
    &__body-text {
        @include font(inherit, 14px, inherit);
        margin-bottom: 20px !important;
    }
    &__body-item {
        @include font(inherit, 14px, 140%);
        padding-left: 20px !important;
        & span {
            @include font(700, 14px, 140%);
        }
        &:not(:last-child) {
            margin-bottom: 15px;
        }
    ...
    &__btn-back {
        ...
        &::before {
            content: '';
            background-image: url(@/assets/images/arrow-right-small-white.svg);
